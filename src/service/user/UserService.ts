...
import { TypeObjParams, TypeObjParamsStatusUser } from '../../interface/list-user/list_user.interface';
...
export const activeUser = async (objParamsId: TypeObjParamsStatusUser) => {
	return await apiClient.post(`/admin/active-user`, objParamsId);
};
